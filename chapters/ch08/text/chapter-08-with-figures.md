...
![Figure 8.2 — Hassabis's AGI as coordination: an R1 loop of Specialized Capabilities, Meta-Learning, and Goal-Directed Behavior routed through a coordination system that integrates perception, reasoning, and action rather than scaling any single component.](../diagrams/png/ch08-03-hassabis-agi.png)
...
![Figure 8.3 — Bostrom's control problem as a DAG: Intelligence Capability and Goal Structure are orthogonal, and a latent "true human values" confounder makes containment alone fail — only value learning plus corrigibility close the loop into aligned superintelligence.](../diagrams/png/ch08-02-bostrom-control.png)
