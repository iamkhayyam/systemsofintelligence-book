...
![Figure 2.2 — Pearl's Ladder of Causation: Observation, Intervention, and Counterfactual rungs, with the latent Imagination node representing the missing rung that statistical AI cannot climb.](../diagrams/png/ch02-02-pearl-ladder-causation.png)
...
![Figure 2.5 — High-frequency trading market coordination: a reinforcing loop (R1) of price discovery coupled with a balancing loop (B1) of risk management—the book's first mixed-loop diagram.](../diagrams/png/ch02-05-hft-market-coordination.png)
