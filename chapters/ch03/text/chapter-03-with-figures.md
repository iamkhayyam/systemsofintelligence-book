...
![Figure 3.2 — Constitutional AI / RLAIF balancing loop: AI Capability, Human Values, and the Constitutional Framework coordinate so critique suppresses misaligned capability.](../diagrams/png/ch03-02-constitutional-ai-rlaif.png)
...
![Figure 3.3 — JEPA self-supervised coordination: Past Context and Future Context coordinate through a Prediction Task over abstract representations to recover the present.](../diagrams/png/ch03-03-jepa-coordination.png)
...
![Figure 3.4 — AlphaGo's three-body system: Policy Network, Value Network, and Monte Carlo Tree Search form two reinforcing self-play loops that produced Move 37's emergent coordination.](../diagrams/png/ch03-04-alphago-three-networks.png)
...
![Figure 3.5 — AlphaFold coordination DAG: Evolutionary Information, Physical Constraints, and Attention Architecture merge to model how amino acids coordinate in 3D space.](../diagrams/png/ch03-05-alphafold-coordination.png)
...
![Figure 3.6 — Two-body brittleness across MYCIN, industrial robots, supervised learning, and bureaucracy, with a latent "Missing Third Body" node showing the shared shape of all four failure cases.](../diagrams/png/ch03-06-two-body-brittleness.png)
