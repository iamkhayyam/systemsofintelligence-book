...
![Figure 9.6 — Coordination fork: Individual Needs and Community Capacity coordinate through Coordination Infrastructure into a virtuous loop or, with the latent platform-ownership switch (dashed) flipped to extraction, a vicious loop.](../diagrams/png/ch09-06-menegon-mutual-aid-fork.png)

*Figure 9.6 — Coordination virtuous/vicious fork. See `../diagrams/svg/ch09-06-menegon-mutual-aid-fork.svg` for the vector source.*
