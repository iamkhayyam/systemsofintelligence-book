...
![Figure 9.2 — Chollet's coordination death spiral: System Complexity drives Integration Overhead drives Cognitive Load drives more System Complexity in a reinforcing loop.](../diagrams/png/ch09-02-chollet-death-spiral.png)

*Figure 9.2 — Chollet coordination death spiral. See `../diagrams/svg/ch09-02-chollet-death-spiral.svg` for the vector source.*
...
![Figure 9.3 — Raworth's doughnut: Ecological Foundation and Social Foundation bound the Economic System; planetary pushback balances overshoot and the latent regenerative-distribution node (dashed) closes the loop.](../diagrams/png/ch09-05-raworth-doughnut-overshoot.png)

*Figure 9.3 — Raworth doughnut overshoot and regenerative distribution. See `../diagrams/svg/ch09-05-raworth-doughnut-overshoot.svg` for the vector source.*
...
![Figure 9.4 — Yang's automation gap: Technological Displacement decouples from Human Economic Security when the Distribution Mechanism breaks; the latent UBI node (dashed) re-couples capability to security.](../diagrams/png/ch09-03-yang-automation-distribution.png)

*Figure 9.4 — Yang automation and distribution gap. See `../diagrams/svg/ch09-03-yang-automation-distribution.svg` for the vector source.*
...
![Figure 9.5 — Turkle's conversation erosion loop: Technology Mediation fragments attention, erodes Human Relating, and drives more mediation in a reinforcing loop against Cultural Norms.](../diagrams/png/ch09-04-turkle-conversation-erosion.png)

*Figure 9.5 — Turkle conversation erosion loop. See `../diagrams/svg/ch09-04-turkle-conversation-erosion.svg` for the vector source.*
...
![Figure 9.6 — Menegon's mutual aid fork: Individual Needs and Community Capacity coordinate through Coordination Infrastructure into a virtuous loop or, with the latent platform-ownership switch (dashed) flipped to extraction, a vicious loop.](../diagrams/png/ch09-06-menegon-mutual-aid-fork.png)

*Figure 9.6 — Menegon mutual aid virtuous/vicious fork. See `../diagrams/svg/ch09-06-menegon-mutual-aid-fork.svg` for the vector source.*
